...
export default function AgencyBookingser({ sidebarOpen, setSidebarOpen }) {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        const agencyBookings = res.data.filter(b => b.agencyId === agencyId);
          ...
          <Col lg={12}>
            <div className="manage-heading d-flex align-items-center justify-content-between">
              <div className="manage-headings">
                <h2 className="dashboard-title">Agency Manage Bookings</h2>
              </div>
                ...
                <Table striped bordered hover>
                  ...
                  <tbody>
                    {filteredBookings.length > 0 ? (
                      ...
                      <tr>
                        <td colSpan="14" className="text-center">No bookings found</td>
                      </tr>
                    )}
                  </tbody>
                </Table>
